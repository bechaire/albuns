...
final class Version20240129000201 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usuarios (idusuario INT AUTO_INCREMENT NOT NULL, usuario VARCHAR(45) NOT NULL, email VARCHAR(75) NOT NULL, nome VARCHAR(65) NOT NULL, roles VARCHAR(255) DEFAULT NULL, ativo VARCHAR(1) NOT NULL, ultacesso DATETIME DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, PRIMARY KEY(idusuario)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
